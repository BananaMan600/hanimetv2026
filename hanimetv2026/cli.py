...
def main():
    ...
    download_group.add_argument("--sleep-time", "-s", dest="sleep_time", help="Sleep time between retries", type=int, default=30)
    ...
    path_group.add_argument("--errors-dir", dest="errors_dir", help="Path to .txt file for failed downloads", type=str, default=None)
    ...
    mode_group.add_argument("--video", help="Video URL", type=str, default=None)
    mode_group.add_argument("--all", "-a", help="Download all videos", action="store_true", default=False)
    ...
    mode_group.add_argument("--update", help="Check for updates to videos already downloaded (only with --search)", action="store_true", default=False)
    mode_group.add_argument("--only-posters", help="Only download posters for videos", action="store_true", default=False)
    mode_group.add_argument("--add-only-metadata", help="Adds metadata and thumbnail to already downloaded videos in batch file", action="store_true", default=False)
